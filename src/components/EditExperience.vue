        ...
        <v-card width="100%" color="transparent" class="pa-2">
            <div v-if="!editing">
                ...
                <table>
                    <tr>
                        <td>Profession:</td>
                        <td><b>{{ experienceModel.profession }}</b></td>
                    </tr>
                    <tr>
                        <td>Field:</td>
                        <td><b>{{ experienceModel.field }}</b></td>
                    </tr>
                    <tr>
                        <td>Hospital:</td>
                        <td><b>{{ experienceModel.hospital }}</b></td>
                    </tr>
                    <tr>
                        <td>Term Start:</td>
                        <td><b>{{ experienceModel.term_start }}</b></td>
                    </tr>
                    <tr>
                        <td>Term End:</td>
                        <td><b>{{ experienceModel.term_end }}</b></td>
                    </tr>
                    <tr>
                        <td>Country:</td>
                        <td><b>{{ experienceModel.country }}</b></td>
                    </tr>
                </table>
            </div>
            <div v-else>
                <div>
                    <p>No: {{ index + 1 }}</p>
                    <v-text-field v-model="experienceModel.profession"
                                  class="mt-2"
                                  label="Profession"
                                  variant="outlined"
                                  density="compact"
                                  hide-details></v-text-field>
                    <v-text-field v-model="experienceModel.hospital"
                                  class="mt-2"
                                  label="Hospital"
                                  variant="outlined"
                                  density="compact"
                                  hide-details></v-text-field>
                    <v-text-field v-model="experienceModel.field"
                                  class="mt-2"
                                  label="Field"
                                  variant="outlined"
                                  density="compact"
                                  hide-details></v-text-field>
                    <v-text-field v-model="experienceModel.term_start"
                                  type="number"
                                  class="mt-2"
                                  label="Term Start"
                                  variant="outlined"
                                  density="compact"
                                  hide-details></v-text-field>
                    <v-text-field v-model="experienceModel.term_end"
                                  type="number"
                                  class="mt-2"
                                  label="Term End"
                                  variant="outlined"
                                  density="compact"
                                  hide-details></v-text-field>
                    <v-text-field v-model="experienceModel.country"
                                  class="mt-2"
                                  label="Country"
                                  variant="outlined"
                                  density="compact"
