        ...
        <v-card width="100%" color="transparent" class="pa-2">
            <div v-if="!editing">
                ...
                <table>
                    <tr>
                        <td>Degree:</td>
                        <td>
                            <b>{{ educationModel.degree }}</b>
                        </td>
                    </tr>
                    <tr>
                        <td>Major:</td>
                        <td>
                            <b>{{ educationModel.major }}</b>
                        </td>
                    </tr>
                    <tr>
                        <td>Institution:</td>
                        <td>
                            <b>{{ educationModel.institution }}</b>
                        </td>
                    </tr>
                    <tr>
                        <td>Term Start:</td>
                        <td>
                            <b>{{ educationModel.term_start }}</b>
                        </td>
                    </tr>
                    <tr>
                        <td>Term End:</td>
                        <td>
                            <b>{{ educationModel.term_end }}</b>
                        </td>
                    </tr>
                    <tr>
                        <td>Country:</td>
                        <td>
                            <b>{{ educationModel.country }}</b>
                        </td>
                    </tr>
                </table>
            </div>
            <div v-else>
                <div>
                    ...
                    ></v-text-field>
                    <v-text-field
                        v-model="educationModel.institution"
                        class="mt-2"
                        label="Institution"
                        variant="outlined"
                        density="compact"
                    ...
                    ></v-text-field>
                    <v-text-field
                        v-model="educationModel.term_start"
                        type="number"
                        class="mt-2"
                        label="Term Start"
                        variant="outlined"
                    ...
                    ></v-text-field>
                    <v-text-field
                        v-model="educationModel.term_end"
                        type="number"
                        class="mt-2"
                        label="Term End"
                        variant="outlined"
