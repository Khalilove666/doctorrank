    ...
    <div class="pt-10 d-flex justify-center">
        <v-card class="px-4 py-4" min-width="350px" max-width="350px">
            ...
            <div v-if="!success">
                ...
                <v-btn :disabled="loading" class="mt-4 bg-accent text-white-text" block @click="handleRegister()">
                    {{ $t("btn_register") }}
                </v-btn>
            ...
            <div v-else class="d-flex flex-column mt-4">
                ...
                <p class="mt-4 align-self-center">
                    We have just sent you confirmation mail. Please check your inbox to activate your profile.
                </p>
            </div>
        </v-card>
    </div>
